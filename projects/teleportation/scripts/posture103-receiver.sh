...
SDP_PCL_FILE_LOCATION_2="http://posture102.local:8260/sdp?rtpsession=pclsender&destination=pclmixer"
SDP_PULSE_FILE_LOCATION_1="http://posture101.local:8250/sdp?rtpsession=pulsesender&destination=pulsemixer"
SDP_PULSE_FILE_LOCATION_2="http://posture102.local:8260/sdp?rtpsession=pulsesender&destination=pulsemixer"
SDP_GET_QUID=uridecodebin

# Point clouds
switcher-ctrl -S $SENDER_URL -C $SDP_GET_QUID pclstream_1
sleep 1
switcher-ctrl -S $SENDER_URL -i pclstream_1 to_shmdata $SDP_FILE_LOCATION_1
sleep 2
switcher-ctrl -S $SENDER_URL -C $SDP_GET_QUID pclstream_2
sleep 1
switcher-ctrl -S $SENDER_URL -i pclstream_2 to_shmdata $SDP_FILE_LOCATION_2
sleep 2
