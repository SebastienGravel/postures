...
sleep 1
switcher-ctrl -S $SENDER_URL -i pulsesender add_udp_stream_to_dest /tmp/switcher_default_mic_gstsrc pulsemixer_1 21654
sleep 1
switcher-ctrl -S $SENDER_URL -i pulsesender add_udp_stream_to_dest /tmp/switcher_default_mic_gstsrc pulsemixer_2 21656
