...
sleep 1
switcher-ctrl -S $SENDER_URL -i pclsender add_udp_stream_to_dest $PCL_NAME pclmixer_1 21670
sleep 1
switcher-ctrl -S $SENDER_URL -i pclsender add_udp_stream_to_dest $PCL_NAME pclmixer_2 21672
